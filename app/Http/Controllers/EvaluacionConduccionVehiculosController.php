    ...
    public function store(Request $request)
    {
      if(request()->ajax()) {
          ...
          $conduccionvehiculo = EvaluacionConduccionVehiculos::create([
            ...
            'anamnesis_evaluacion_capacidades1'=>isset($data['anamnesis_evaluacion_capacidades1'])? $data['anamnesis_evaluacion_capacidades1']:null,
            'anamnesis_evaluacion_capacidades2'=>isset($data['anamnesis_evaluacion_capacidades2'])? $data['anamnesis_evaluacion_capacidades2']:null,
            'anamnesis_evaluacion_capacidades3'=>isset($data['anamnesis_evaluacion_capacidades3'])? $data['anamnesis_evaluacion_capacidades3']:null,
            'anamnesis_evaluacion_capacidades4'=>isset($data['anamnesis_evaluacion_capacidades4'])? $data['anamnesis_evaluacion_capacidades4']:null,
            'anamnesis_evaluacion_capacidades5'=>isset($data['anamnesis_evaluacion_capacidades5'])? $data['anamnesis_evaluacion_capacidades5']:null,
            'anamnesis_evaluacion_capacidades6'=>isset($data['anamnesis_evaluacion_capacidades6'])? $data['anamnesis_evaluacion_capacidades6']:null,
            'anamnesis_evaluacion_capacidades7'=>isset($data['anamnesis_evaluacion_capacidades7'])? $data['anamnesis_evaluacion_capacidades7']:null,
            'anamnesis_evaluacion_capacidades8'=>isset($data['anamnesis_evaluacion_capacidades8'])? $data['anamnesis_evaluacion_capacidades8']:null,
            'anamnesis_evaluacion_capacidades9'=>isset($data['anamnesis_evaluacion_capacidades9'])? $data['anamnesis_evaluacion_capacidades9']:null,
            'anamnesis_evaluacion_capacidades10'=>isset($data['anamnesis_evaluacion_capacidades10'])? $data['anamnesis_evaluacion_capacidades10']:null,
            ...
            'exploracion_fisica_capacidades1'=>isset($data['exploracion_fisica_capacidades1'])? $data['exploracion_fisica_capacidades1']:null,
            'exploracion_fisica_capacidades2'=>isset($data['exploracion_fisica_capacidades2'])? $data['exploracion_fisica_capacidades2']:null,
            'exploracion_fisica_capacidades3'=>isset($data['exploracion_fisica_capacidades3'])? $data['exploracion_fisica_capacidades3']:null,
            'exploracion_fisica_capacidades4'=>isset($data['exploracion_fisica_capacidades4'])? $data['exploracion_fisica_capacidades4']:null,
            'exploracion_fisica_capacidades5'=>isset($data['exploracion_fisica_capacidades5'])? $data['exploracion_fisica_capacidades5']:null,
            'exploracion_fisica_capacidades6'=>isset($data['exploracion_fisica_capacidades6'])? $data['exploracion_fisica_capacidades6']:null,
            'exploracion_fisica_capacidades7'=>isset($data['exploracion_fisica_capacidades7'])? $data['exploracion_fisica_capacidades7']:null,
            'exploracion_fisica_capacidades8'=>isset($data['exploracion_fisica_capacidades8'])? $data['exploracion_fisica_capacidades8']:null,
            'exploracion_fisica_capacidades9'=>isset($data['exploracion_fisica_capacidades9'])? $data['exploracion_fisica_capacidades9']:null,
            'exploracion_fisica_capacidades10'=>isset($data['exploracion_fisica_capacidades10'])? $data['exploracion_fisica_capacidades10']:null,
