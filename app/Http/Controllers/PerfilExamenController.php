...
//        $listaexamenes = ListaExamen::selectRaw('lista_examenes.* from list_examenes where lista_examenes.id not in (select lista_examen_id from perfil_examenes where perfil_examenes.perfil_id = ?)',[$perfil->id])->get();
