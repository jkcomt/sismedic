        ...
        @foreach($grupoSanguineos as $grupoSanguineo)
            <tr>
                <td>{{$grupoSanguineo->descripcion}}</td>    
                 <td>
                   <button class="btn btn-xs btn-warning edit"  value="{{$grupoSanguineo->id}}"><span class="glyphicon glyphicon-pencil"></span> EDIT.</button>
                    {{csrf_field()}}
                    ...
                    <button href="#" class="btn btn-xs btn-danger delete"  id="{{$grupoSanguineo->id}}"><span class="glyphicon glyphicon-remove"></span> ELIM.</button>
                </td>
            </tr>
        @endforeach
        </tbody>
