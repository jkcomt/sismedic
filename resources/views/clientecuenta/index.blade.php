...
<a class="btn btn-sm btn-warning" href="{{route('cliente_cuenta.index')}}">Volver</a>
@endsection
...
@section('content')
@include('clientecuenta.modals.create')
@include('clientecuenta.modals.edit')
...
@endsection
@section('script')
<script src="{{asset('js/clientecuenta.js')}}"></script>
@endsection
