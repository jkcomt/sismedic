<div class="modal fade" tabindex="-1" role="dialog" id="modal-glucosa">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            @include('evaluacionmedica.examenes.encabezado')
            <form action="{{route('glucosa.store')}}" id="registrarGlucosa" method="post">
                  ...
                  <div class="col-md-12">
                    <div class="form-horizontal">
                      <div class="form-group">
                       ...
                       <label for="inputEmail3" class="col-sm-2 control-label text-danger"><strong> 74-106 </strong> </label>
                     </div>
                    </div>
                  </div>
