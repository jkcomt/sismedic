        ...
        @foreach($tipoExamens as $tipoExamen)
            <tr>
                <td>{{$tipoExamen->descripcion}}</td>
                 <td>
                   <button class="btn btn-xs btn-warning edit"  value="{{$tipoExamen->id}}"><span class="glyphicon glyphicon-pencil"></span> EDIT.</button>
                    {{csrf_field()}}
                    ...
                    <button href="#" class="btn btn-xs btn-danger delete"  id="{{$tipoExamen->id}}"><span class="glyphicon glyphicon-remove"></span> ELIM.</button>
                </td>
            </tr>
        @endforeach
        </tbody>
