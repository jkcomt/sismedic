...
@section('header')
<div class="row">
  <div class="col-sm-6">LISTADO DE TIPOS EXAMEN
  </div>
...
<a class="btn btn-sm btn-warning" href="{{route('tipo_examen.index')}}">Volver</a>
@endsection
...
@include('tipoexamen.modals.create')
@include('tipoexamen.modals.edit')
...
<div class="row">
    ...
    {{-- <a href="{{route('configuracion.index')}}" class="btn btn-warning">VOLVER</a> --}}
            <button class="btn btn-success new">NUEVO TIPO EXAMEN</button>
...
<div class="row" id="tabla">
     ...
     @include('tipoexamen.table')
</div>
@endsection
@section('script')
<script src="{{asset('js/tipoexamen.js')}}"></script>
@endsection
