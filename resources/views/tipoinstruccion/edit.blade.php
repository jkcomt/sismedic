...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form action="{{route('tipoinstruccion.update')}}" id="actualizarPaciente">
                {{csrf_field()}}
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="hidden" value="{{$tipoInstruccion->id}}" name="id">
                                <input type="text"  value="{{$tipoInstruccion->nombre}}" class="form-control" name="nombre">
                            </div>
                        </div>
