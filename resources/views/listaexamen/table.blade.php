        ...
        @foreach($listaexamenes as $listaexamen)
            <tr>
                ...
                <td>{{$listaexamen->dscto}}</td>
                 <td>
                   <button class="btn btn-xs btn-warning edit"  value="{{$listaexamen->id}}"><span class="glyphicon glyphicon-pencil"></span> EDIT.</button>
                    {{csrf_field()}}
                    ...
                    <button href="#" class="btn btn-xs btn-danger delete"  id="{{$listaexamen->id}}"><span class="glyphicon glyphicon-remove"></span> ELIM.</button>
                </td>
            </tr>
        @endforeach
        </tbody>
