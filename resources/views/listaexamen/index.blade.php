...
@section('header')
<div class="row">
  <div class="col-sm-6">LISTADO DE EXAMENES
  </div>
...
<a class="btn btn-sm btn-warning" href="{{route('lista_examen.index')}}">Volver</a>
@endsection
...
@include('listaexamen.modals.create')
@include('listaexamen.modals.edit')
...
<div class="row">
    ...
    {{-- <a href="{{route('configuracion.index')}}" class="btn btn-warning">VOLVER</a> --}}
            <button class="btn btn-success new">NUEVO EXAMEN</button>
...
@include('listaexamen.table')
</div>
@endsection
@section('script')
<script src="{{asset('js/listaexamen.js')}}"></script>
@endsection
