$(document).ready(function() {
    ...
    $('#msg-error').hide();
console.log("contrata.js ");
});

/***************************CREATE*********************************/
$('#registrarContrata').submit(function(e){
    e.preventDefault();

    var datos = $('#registrarContrata');
   ...
   $.post(url,datos.serialize(),function (result) {
    ...
    }).success(function(data)
    {
        if($.isEmptyObject(data.error)){
            console.log(data)
            $('#modal-contrata-create').modal('hide')
            $('#modal-exito').modal({
                backdrop: 'static',
                keyboard:false
            });
...
//		alert("hola");
      $('#modal-contrata-create').modal('show');
});
...
$('body').on('click','.edit',function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modal-contrata-edit input[name=editnombre]').val(data.nombre)
         
            $('#modal-contrata-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#editarContrata').attr('action');
    ...
    $.ajax({
        ...
        success: function(data){
            $('#modal-contrata-edit').modal('hide');
            location.reload();
