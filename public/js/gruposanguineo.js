$(document).ready(function() {
    ...
    $('#msg-error').hide();
console.log("gruposanguineo.js ");
});

/***************************CREATE*********************************/
$('#registrarGrupoSanguineo').submit(function(e){
    e.preventDefault();

    var datos = $('#registrarGrupoSanguineo');
   ...
   $.post(url,datos.serialize(),function (result) {
    ...
    }).success(function(data)
    {
        if($.isEmptyObject(data.error)){
            console.log(data)
            $('#modal-gruposanguineo-create').modal('hide')
            $('#modal-exito').modal({
                backdrop: 'static',
                keyboard:false
            });
...
//		alert("hola");
      $('#modal-gruposanguineo-create').modal('show');
});
...
$('body').on('click','.edit',function(e){
    ...
    var url = "/gruposanguineo/"+id+"/edit"
    $.ajax({
        type:"get",
        url:url,
        dataType:"json",
        ...
        success: function(data){
            ...
            $('#modal-gruposanguineo-edit input[name=editnombre]').val(data.descripcion)
         
            $('#modal-gruposanguineo-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#editarGrupoSanguineo').attr('action');
    ...
    $.ajax({
        ...
        success: function(data){
            $('#modal-gruposanguineo-edit').modal('hide');
            location.reload();
