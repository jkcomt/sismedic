...
/***************************CREATE*********************************/
$('#registrarCargo').submit(function(e){
    e.preventDefault();

    var datos = $('#registrarCargo');
...
$('body').on('click','.edit',function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modal-cargo-edit input[name=editnombre]').val(data.descripcion)

            $('#modal-cargo-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#editarCargo').attr('action');
