$(document).ready(function() {
    ...
    $('#msg-error').hide();
console.log("lugarlabor.js ");
});

/***************************CREATE*********************************/
$('#registrarLugarLabor').submit(function(e){
    e.preventDefault();

    var datos = $('#registrarLugarLabor');
   ...
   $.post(url,datos.serialize(),function (result) {
    ...
    }).success(function(data)
    {
        if($.isEmptyObject(data.error)){
            console.log(data)
            $('#modal-lugarlabor-create').modal('hide')
            $('#modal-exito').modal({
                backdrop: 'static',
                keyboard:false
            });
...
//		alert("hola");
      $('#modal-lugarlabor-create').modal('show');
});
...
$('body').on('click','.edit',function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modal-lugarlabor-edit input[name=editnombre]').val(data.nombre)
         
            $('#modal-lugarlabor-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#editarLugarLabor').attr('action');
    ...
    $.ajax({
        ...
        success: function(data){
            $('#modal-lugarlabor-edit').modal('hide');
            location.reload();
