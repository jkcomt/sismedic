$(document).ready(function() {
    ...
    $('#msg-error').hide();
console.log("clientecuenta.js ");
});

/***************************CREATE*********************************/
$('#registrarClienteCuenta').submit(function(e){
    e.preventDefault();

    var datos = $('#registrarClienteCuenta');
   ...
   $.post(url,datos.serialize(),function (result) {
    ...
    }).success(function(data)
    {
        if($.isEmptyObject(data.error)){
            console.log(data)
            $('#modal-clientecuenta-create').modal('hide')
            $('#modal-exito').modal({
                backdrop: 'static',
                keyboard:false
            });
...
//		alert("hola");
      $('#modal-clientecuenta-create').modal('show');
});
...
$('body').on('click','.edit',function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modal-clientecuenta-edit input[name=editnombre]').val(data.descripcion)

            $('#modal-clientecuenta-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#editarClienteCuenta').attr('action');
    ...
    $.ajax({
        ...
        success: function(data){
            $('#modal-clientecuenta-edit').modal('hide');
            location.reload();
