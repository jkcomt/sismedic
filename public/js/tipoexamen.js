$(document).ready(function() {
    ...
    $('#msg-error').hide();
console.log("tipoexamen.js ");
});

/***************************CREATE*********************************/
$('#registrarTipoExamen').submit(function(e){
    e.preventDefault();
   ...
   $.post(url,datos.serialize(),function (result) {
    ...
    }).success(function(data)
    {
        if($.isEmptyObject(data.error)){
            console.log(data)
            $('#modal-tipoexamen-create').modal('hide')
            $('#modal-exito').modal({
                backdrop: 'static',
                keyboard:false
            });
...
//		alert("hola");
      $('#modal-tipoexamen-create').modal('show');
});
...
$('body').on('click','.edit',function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modal-tipoexamen-edit input[name=editnombre]').val(data.descripcion)

            $('#modal-tipoexamen-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#editarTipoExamen').attr('action');
    ...
    $.ajax({
        ...
        success: function(data){
            $('#modal-tipoexamen-edit').modal('hide');
            location.reload();
