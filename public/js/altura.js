$(document).ready(function() {
    ...
    $('#msg-error').hide();
console.log("altura.js ");
});

/***************************CREATE*********************************/
$('#registrarAltura').submit(function(e){
    e.preventDefault();

    var datos = $('#registrarAltura');
   ...
   $.post(url,datos.serialize(),function (result) {
    ...
    }).success(function(data)
    {
        if($.isEmptyObject(data.error)){
            console.log(data)
            $('#modal-altura-create').modal('hide')
            $('#modal-exito').modal({
                backdrop: 'static',
                keyboard:false
            });
...
//		alert("hola");
      $('#modal-altura-create').modal('show');
});
...
$('body').on('click','.edit',function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#modal-altura-edit input[name=editnombre]').val(data.descripcion)
         
            $('#modal-altura-edit').modal('show');
        },
        error: function(data){
...
$('#update').on('click',function (e) {
    ...
    var url = $('#editarAltura').attr('action');
